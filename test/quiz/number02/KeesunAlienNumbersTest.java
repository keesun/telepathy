...
public class KeesunAlienNumbersTest {
	...
	public void googleCodeJam() throws IOException {
		...
		BufferedReader in = new BufferedReader(new FileReader("/workspace/telepathy/test/quiz/number02/A-large-practice.in"));
		String s;
		int lineNum = 0;
		int problemNum = 0;
		String answer = "";
		...
		BufferedWriter out = new BufferedWriter(new FileWriter("/workspace/telepathy/test/quiz/number02/A-large-practice.out"));
		out.write(answer);
		out.close();
	}
